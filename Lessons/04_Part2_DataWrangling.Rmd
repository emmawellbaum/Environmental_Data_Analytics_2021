...
# Transforms the five nutrient columns into two columns: a "nutrient" column with the five nutrient types (previously column headers) and a "concentration" column with the values.
